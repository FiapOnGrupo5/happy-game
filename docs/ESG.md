...
Nota de revisao: este documento descreve o estado academico atual (MVP frontend). Para ambiente de producao, as recomendacoes de LGPD devem ser implementadas junto com backend e politica de privacidade formal.
